...
class Viewer {
    ...
    reset() {
        ...
        try {
            this.fitter = new WasmFitter(FIT_SIZE, FIT_SIZE, this.targetRgba, triangles, iters, 0);
        }
        catch (err) {
...
function insideTriangle(v, px, py) {
    const [a, b, c] = v;
